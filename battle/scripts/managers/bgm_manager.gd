...
var bgm_title = preload("res://assets/audio/bgm/title_menu_maou_bgm_acoustic48.mp3")
var bgm_stage_select = preload("res://assets/audio/bgm/stage_select_maou_bgm_acoustic36.mp3")
